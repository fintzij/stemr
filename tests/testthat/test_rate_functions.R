...
test_that("Rates are computed properly for a simple system", {
        ...
        # set dynamics
        dynamics <- stem_dynamics(rates = rates, parameters = parameters, tmax = tmax, state_initializer = state_initializer, compartments=compartments, strata = strata, tcovar = tcovar, messages = FALSE)
...
test_that("Rates are computed properly for a simple system with two time-varying covariates", {
        ...
        # set dynamics
        dynamics <- stem_dynamics(rates = rates, parameters = parameters, state_initializer = state_initializer, compartments=compartments, strata = strata, tcovar = tcovar, t0 = t0, tmax = tmax, messages = FALSE)
...
test_that("Rates are computed properly for a complex system with time varying covariates", {
        ...
        # set dynamics
        dynamics <- stem_dynamics(rates = rates, parameters = parameters,state_initializer = state_initializer, compartments=compartments, strata = strata, adjacency = adjacency, t0 = t0, tmax = tmax, tcovar = tcovar, messages = FALSE)
