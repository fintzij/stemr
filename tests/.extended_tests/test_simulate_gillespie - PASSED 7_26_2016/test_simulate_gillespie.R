...
# the GillespieSSA package. Three models are simulated: simple SIR (simulation 1),
# SIRS with seasonality (simulation 2), SIRS with seasonality and two strata.
# Each of the simulations will produce a plot comparing the trajectories produced
# by simulate epimodel with the trajectories produced by GillespieSSA.
