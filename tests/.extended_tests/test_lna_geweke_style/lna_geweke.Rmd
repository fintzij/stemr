...
lna_ess_set_pars_pointer <- stem_object$dynamics$lna_pointers$lna_ess_set_pars_ptr
...
for(k in 2:iterations) {
        ...
        path <- update_lna_path(
                        ...
                        emitmat                 = emitmat,
                        flow_matrix             = flow_matrix,
                        lna_pointer             = lna_pointer_ess,
                        set_ess_pars_pointer    = lna_ess_set_pars_pointer,
                        lna_times               = lna_times,
                        lna_initdist_inds       = lna_initdist_inds,
                        param_update_inds       = param_update_inds,
                        incidence_codes         = incidence_codes,
...
lna_paths_mcmc <- latent_lna_paths
natural_paths_mcmc <- latent_paths_natural

# extract the S2I and I compartments from the relevant objects
I_nat_sim   <- natural_paths_sim[,3,]
S2I_lna_sim <- lna_paths_sim[,2,]

I_nat_mcmc   <- natural_paths_mcmc[,3,]
S2I_lna_mcmc <- lna_paths_mcmc[,2,]
