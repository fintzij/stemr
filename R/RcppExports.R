...
pars2lnapars2 <- function(lnapars, parameters, c_start) {
    invisible(.Call('_stemr_pars2lnapars2', PACKAGE = 'stemr', lnapars, parameters, c_start))
}
...
copy_elem2 <- function(dest, orig, inds) {
    invisible(.Call('_stemr_copy_elem2', PACKAGE = 'stemr', dest, orig, inds))
}
...
copy_vec2 <- function(dest, orig, inds) {
    invisible(.Call('_stemr_copy_vec2', PACKAGE = 'stemr', dest, orig, inds))
}
...
insert_block <- function(dest, orig, rowinds, colinds) {
    invisible(.Call('_stemr_insert_block', PACKAGE = 'stemr', dest, orig, rowinds, colinds))
}
...
copy_pathmat <- function(dest, orig) {
    invisible(.Call('_stemr_copy_pathmat', PACKAGE = 'stemr', dest, orig))
}
...
reset_vec <- function(v, value = 0) {
    invisible(.Call('_stemr_reset_vec', PACKAGE = 'stemr', v, value))
}
...
add2vec <- function(target, increments, inds) {
    invisible(.Call('_stemr_add2vec', PACKAGE = 'stemr', target, increments, inds))
}
...
integrate_odes <- function(ode_times, ode_pars, ode_param_inds, ode_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, step_size, ode_pointer, set_pars_pointer) {
    .Call('_stemr_integrate_odes', PACKAGE = 'stemr', ode_times, ode_pars, ode_param_inds, ode_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, step_size, ode_pointer, set_pars_pointer)
}
...
map_draws_2_lna <- function(pathmat, draws, lna_times, lna_pars, lna_param_vec, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, svd_d, svd_U, svd_V, step_size, lna_pointer, set_pars_pointer) {
    invisible(.Call('_stemr_map_draws_2_lna', PACKAGE = 'stemr', pathmat, draws, lna_times, lna_pars, lna_param_vec, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, svd_d, svd_U, svd_V, step_size, lna_pointer, set_pars_pointer))
}
...
map_pars_2_ode <- function(pathmat, ode_times, ode_pars, ode_param_inds, ode_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, step_size, ode_pointer, set_pars_pointer) {
    invisible(.Call('_stemr_map_pars_2_ode', PACKAGE = 'stemr', pathmat, ode_times, ode_pars, ode_param_inds, ode_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, step_size, ode_pointer, set_pars_pointer))
}
...
comp_chol <- function(C, M) {
    invisible(.Call('_stemr_comp_chol', PACKAGE = 'stemr', C, M))
}
...
mvn_g_adaptive <- function(params_prop, params_cur, kernel_cov_chol, nugget) {
    invisible(.Call('_stemr_mvn_g_adaptive', PACKAGE = 'stemr', params_prop, params_cur, kernel_cov_chol, nugget))
}
...
normalise2 <- function(v, p) {
    .Call('_stemr_normalise2', PACKAGE = 'stemr', v, p)
}
...
propose_lna_approx <- function(lna_times, lna_pars, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, max_attempts, nsim, ess_updates, ess_warmup, step_size, lna_pointer, set_pars_pointer) {
    .Call('_stemr_propose_lna_approx', PACKAGE = 'stemr', lna_times, lna_pars, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, max_attempts, nsim, ess_updates, ess_warmup, step_size, lna_pointer, set_pars_pointer)
}
...
propose_lna <- function(lna_times, lna_pars, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, max_attempts, step_size, lna_pointer, set_pars_pointer) {
    .Call('_stemr_propose_lna', PACKAGE = 'stemr', lna_times, lna_pars, lna_param_inds, lna_tcovar_inds, init_start, param_update_inds, stoich_matrix, forcing_inds, forcing_matrix, max_attempts, step_size, lna_pointer, set_pars_pointer)
}
...
update_interval_widths <- function(interval_widths, n_expansions_afss, n_contractions_afss, c_expansions_afss, c_contractions_afss, slice_ratios, adaptation_factor, target_ratio) {
    invisible(.Call('_stemr_update_interval_widths', PACKAGE = 'stemr', interval_widths, n_expansions_afss, n_contractions_afss, c_expansions_afss, c_contractions_afss, slice_ratios, adaptation_factor, target_ratio))
}
