...
#' @export
simulate_measproc <- function(censusmat, measproc_indmat, parameters, constants, tcovar, r_measure_ptr) {
    .Call('stemr_simulate_measproc', PACKAGE = 'stemr', censusmat, measproc_indmat, parameters, constants, tcovar, r_measure_ptr)
}
