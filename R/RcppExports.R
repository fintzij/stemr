...
#'   diffusion process.
#' @export
propose_lna_ess <- function(path_cur, lna_times, lna_pars, param_update_inds, flow_matrix, lna_pointer_ess, set_ess_pars_pointer) {
    .Call('stemr_propose_lna_ess', PACKAGE = 'stemr', path_cur, lna_times, lna_pars, param_update_inds, flow_matrix, lna_pointer_ess, set_ess_pars_pointer)
}
