...
#'   compartment volumes) on their natural scales, and the model
...
stem_inference_lna <- function(stem_object,
      ...
      if(!is.null(stem_object$dynamics$forcings)) {
            ...
            forcing_tcov_inds <- match(forcing_tcovars, colnames(lna_params_cur)) - 1
      ...
      parameter_samples_nat <-
            matrix(0.0,
                   ...
                   dimnames = list(NULL, c(names(model_params_nat), convrec_initvol_names))
            )
