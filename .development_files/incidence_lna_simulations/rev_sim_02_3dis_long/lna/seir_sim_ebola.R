...
logprior =
      function(params_est) {
            dnorm(params_est[1], log(1.7), 0.5, log = TRUE) + 
                dnorm(params_est[2], log(9/7), 0.82, log = TRUE) + 
...
saveRDS(results, file = paste0("seir_ebola_",replication,".Rds"))
