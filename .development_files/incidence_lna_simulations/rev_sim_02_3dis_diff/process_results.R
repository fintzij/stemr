...
pmmh_1d_files = list.files("pmmh/results_dt_1day")
  ...
  if(file_exists) {
    ...
    fit = 
      if(combns$method[i] == "lna") {
        ...
        readRDS(paste0("pmmh/results_dt_1day/", res_file))
      }
...
ggsave("threedis_res_all.pdf", plot = all_plots, width = 11, height = 13)
